...
@objcMembers
public final class DevLauncherAppController: NSObject, IAppController, UpdatesExternalInterface {
...
//      }
  ...
  private var previousUpdatesConfiguration: UpdatesConfig? = nil
  ...
  public func getConstantsForModule() -> UpdatesModuleConstants {
    let embeddedUpdate = self.config.let { it in EmbeddedAppLoader.embeddedManifest(withConfig: it, database: self.database) }
